...
const CalendarDaySkeleton = ({ tagCount = 2 }: Props) => {
  return (
    // CalendarDay와 동일한 외부 컨테이너 스타일 (h-32 w-32, p-[5px] 등)
    <div className='inline-flex h-32 w-32 flex-col items-start justify-start gap-3.5 rounded-lg border border-transparent p-[5px]'>
      {/* 날짜 표시 영역 (상단) */}
